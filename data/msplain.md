...
Base: `Any | Null | Bool | Int | Num | Str | Type`
Nullable: `T?`
...
# Return: Str?  # returns null # unrecognized country when unsure
...
# Errors vs Panics
return null # reason         # soft error (preferred for expected absence)
panic("boom")                # hard fault (recoverable via try)
